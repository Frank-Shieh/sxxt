			...
			<div class="content-wrapper">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">修改单个场地管理员信息</h3>
					</div>
					<div id="breadcrumb">
						<a href="#" title="首页" class="tip-bottom"> <i
							class="icon-home"></i> Home
						</a> <a href="listClass.html">场地管理员信息</a> <a href="#" class="current">修改单个场地管理员信息</a>
					</div>
					<div class="panel-body">
						<form class="form-horizontal" method="post"
							action="/siteManager/doEdit" id="registerForm">
								...
								<div class="controls form-group">
									<div class="dropdown btn-group" style="width: 50%">
										<button id="dLabel" class="btn btn-default dropdown-toggle"
											...
											<span id="companyId" value="${siteManager.company.id}">${siteManager.company.name}</span>
											<span class="caret"></span>
										</button>
										<input id='company-input' name="company.id"
											value="${siteManager.company.id}" hidden="true" />
