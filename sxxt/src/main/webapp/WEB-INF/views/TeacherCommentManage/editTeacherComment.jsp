							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<div class="dropdown btn-group" style="width: 50%">
										...
										<input id='school-input' value="${result.classId.major.school.id}"
											hidden="true" />
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<div class="dropdown btn-group" style="width: 50%">
										...
										<input id='major-input' value="${result.classId.major.id}"
											hidden="true" />
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<div class="dropdown btn-group" style="width: 50%">
										...
										<input id='class-input' name="classId.id" value="${result.classId.id}"
											hidden="true" />
