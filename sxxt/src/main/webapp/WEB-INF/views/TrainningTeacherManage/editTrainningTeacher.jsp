...
<body class="hold-transition skin-blue sidebar-mini">
			...
			<div class="content-wrapper">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">修改单个实训教师信息</h3>
					</div>
					<div id="breadcrumb">
						<a href="#" title="首页" class="tip-bottom"> <i
							class="icon-home"></i> Home
						</a> <a href="listClass.html">实训教师信息</a> <a href="#" class="current">修改单个实训教师信息</a>
					</div>
					<div class="panel-body">
						<form class="form-horizontal" method="post"
							action="/trainningTeacher/doEdit" id="registerForm">
							<input type="hidden" class="form-control" name="id"
								value="${trainningTeacher.id}" />
							<!-- 添加工号 -->
							<div class="form-group background">
								<label class="col-sm-3 control-label">工号</label>
								<div class="controls form-group">
									<input type="text" class="form-control" name="code"
										value="${trainningTeacher.code}" />
								</div>
							</div>
							<!-- 添加名字 -->
							<div class="form-group background">
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<input type="text" class="form-control" name="positionName"
										value="${trainningTeacher.positionName}" />
								</div>
							</div>
							<!-- 添加所属公司 -->
							<div class="form-group background">
								...
								<div class="controls form-group">
									<div class="dropdown btn-group" style="width: 50%">
										<button id="dLabel" class="btn btn-default dropdown-toggle"
											...
											<span id="companyId" value="${trainningTeacher.company.id}">${trainningTeacher.company.name}</span>
											<span class="caret"></span>
										</button>
										<input id='company-input' name="company.id"
											value="${trainningTeacher.company.id}" hidden="true" />
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<input type="text" class="form-control" name="password"
										value="${trainningTeacher.password}" />
								</div>
							</div>
	...
	<script>
		...
		$("body").on('click', '.company-menu li', function(e) {
			...
			if ($target.is('a')) {
				...
				updateMajorBycompanyId(companyId);
			}
		});
	...
	<script>
		function updateMajorBycompanyId(id) {
			$
					.ajax({
						type : "POST",
						dataType : 'json',
