			...
			<div class="content-wrapper">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">查看场地信息</h3>
					</div>
					<div id="breadcrumb">
						<a href="#" title="首页" class="tip-bottom"> <i
							class="icon-home"></i> Home
						</a> <a href="listClass.html">场地信息</a> <a href="#" class="current">查看场地信息</a>
					</div>
					<div class="panel-body">
						<form class="form-horizontal" method="post" action="/site/listOnly"
							id="registerForm">
							<!-- 查看区域名称 -->
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<span>${result.classroomCode}</span>
								</div>
							</div>
							<!-- 查看容纳人数 -->
							<div class="form-group background">
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<span>${result.siteManager.name}</span>
								</div>
							</div>
							<!-- 查看状态 -->
							<div class="form-group background">
