			...
			<div class="content-wrapper">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">添加单个场地信息</h3>
					</div>
					<div id="breadcrumb">
						<a href="#" title="首页" class="tip-bottom"> <i
							class="icon-home"></i> Home
						</a> <a href="listClass.html">场地信息</a> <a href="#" class="current">添加单个场地信息</a>
					</div>
					<div class="panel-body">
						<form class="form-horizontal" method="post" action="/site/doAdd"
							id="registerForm">
							<!-- 添加区域名称 -->
								...
								<div class="controls form-group">
									<div class="dropdown btn-group" style="width: 50%">
										<button id="dLabel" class="btn btn-default dropdown-toggle"
											...
											<span id="companyId" value="${companyList.get(0).id}">${companyList.get(0).name}</span>
											<span class="caret"></span>
										</button>
										<input id='company-input' name="company.id"
											value="${companyList.get(0).id}" hidden="true" />
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<div class="dropdown btn-group" style="width: 50%">
										<button id="dLabel" class="btn btn-default dropdown-toggle"
											type="button" data-toggle="dropdown" style="width: 100%">
											<span id="siteManagerId" value="${siteManagerList.get(0).id}">${siteManagerList.get(0).name}</span>
											<span class="caret"></span>
										</button>
										<input id='siteManager-input' name="siteManager.id"
											value="${siteManagerList.get(0).id}" hidden="true" />
										<ul class="dropdown-menu siteManager-menu"
											aria-labelledby="dLabel" role="menu"
											style="width: 100%; height: 150px; overflow: scroll;">
