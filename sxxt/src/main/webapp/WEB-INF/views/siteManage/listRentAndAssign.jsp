...
<body class="hold-transition skin-blue sidebar-mini">
											...
											<c:forEach var="result" items="${result}">
												<tr>
													...
													<td><a class="btn btn-info"
														href="/site/view?id=${result.id}">查看</a></td>
													<td><a class="btn btn-primary"
														href="/site/rent?id=${result.id}">租借</a></td>
													<td><a class="btn btn-danger"
														href="/site/assign?id=${result.id}">分配</a></td>
													<td><a class="btn btn-info"
														href="/site/delState?id=${result.id}">撤销</a></td>
												</tr>
											</c:forEach>
	...
	<script type="text/javascript">
		function delState(id) {
			...
			if (result) {
				console.log(result);
				var url = '/site/delState?id=' + id;
				$.get(url, function(data) {
					console.log('deleted.');
					window.location.href = '/site/rentAndAssign';
				});
			}
		}
	</script>
