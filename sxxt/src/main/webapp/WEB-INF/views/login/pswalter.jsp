				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<div class="alert alert-danger">
							<i class="fa fa-check-circle"></i>密码错误，修改密码失败
							<button type="button" class="close" data-dismiss="alert">&times;</button>
						</div>
					</c:if>
					<c:if test="${param.success==1 }">
						<div class="alert alert-success">
							<i class="fa fa-check-circle"></i>修改密码成功
							<button type="button" class="close" data-dismiss="alert">&times;</button>
						</div>
					</c:if>
						<form class="form-horizontal" method="post"
							action="/password/altersave" id="registerForm">
							<input type="hidden" name="code" value="${user.code}" />
							<!-- 添加名字 -->
							<div class="form-group background">
								<label class="col-sm-3 control-label">原密码</label>
								<div class="controls form-group">
									<input type="text" class="form-control" name="oldpsw" value="" required />
								</div>
							</div>
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<input type="password" class="form-control" name="password" id="newpsw2" required />
