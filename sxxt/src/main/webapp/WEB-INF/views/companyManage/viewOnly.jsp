			...
			<div class="content-wrapper">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">查看实训公司信息</h3>
					</div>
					<div id="breadcrumb">
						<a href="#" title="首页" class="tip-bottom"> <i
							class="icon-home"></i> Home
						</a> <a href="listClass.html">实训公司信息</a> <a href="#" class="current">实训公司信息详情</a>
					</div>
					<div class="panel-body">
						<form class="form-horizontal" method="post" action="/company/listOnly"
							id="registerForm">
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<span><fmt:formatDate value="${result.foundingDate}"
