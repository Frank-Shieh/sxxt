			...
			<div class="content-wrapper">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">修改实训公司信息</h3>
					</div>
					<div id="breadcrumb">
						<a href="#" title="首页" class="tip-bottom"> <i
							class="icon-home"></i> Home
						</a> <a href="listClass.html">实训公司信息</a> <a href="#" class="current">修改实训公司信息</a>
					</div>
					<div class="panel-body">
						<form class="form-horizontal" method="post"
							action="/company/doEdit" id="registerForm">
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<input type="text" class="form-control" name="phone"
										value="${company.phone}" maxlength="11" />
								</div>
							</div>
							<!-- 添加公司地址 -->
							<div class="form-group background">
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<input type="date" class="form-control" name="foundingDate"
										value="<fmt:formatDate  pattern="yyyy-MM-dd" value="${company.foundingDate}"  type="date" dateStyle="default"/>" />
								</div>
							</div>
