			...
			<li class="treeview"><a href="#"> <i class="fa fa-child"
				...
				<ul class="treeview-menu">
					<li><a href="#"><i class="fa fa-circle-o"></i> 场地管理员信息 <span
						...
						<ul class="treeview-menu">
							<li><a href="/company/add"><i class="fa fa-circle-o"></i>添加场地管理员信息</a></li>
							<li><a href="/company/list"><i class="fa fa-circle-o"></i>查看场地管理员列表</a></li>
						</ul></li>
					...
					<li><a href="#"><i class="fa fa-circle-o"></i> 实训教师信息 <span
						...
						<ul class="treeview-menu">
							<li><a href="/site/add"><i class="fa fa-circle-o"></i>添加实训教师信息</a></li>
							<li><a href="/site/list"><i class="fa fa-circle-o"></i>查看实训教师列表</a></li>
						</ul></li>
