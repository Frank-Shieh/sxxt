			...
			<div class="content-wrapper">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">查看实训教学任务信息</h3>
					</div>
					<div id="breadcrumb">
						<a href="#" title="首页" class="tip-bottom"> <i
							class="icon-home"></i> Home
						</a> <a href="listClass.html">实训教学任务信息</a> <a href="#" class="current">查看实训教学任务信息</a>
					</div>
					<div class="panel-body">
						<form class="form-horizontal" method="post"
							action="/teachingTask/list" id="registerForm">
							<!-- 查看名字 -->
							...
							<!-- 查看教务主管名称 -->
							<div class="form-group background">
								<label class="col-sm-3 control-label">教务主管名称</label>
								<div class="controls form-group">
									<span>${result.educationManager.name}</span>
								</div>
							</div>
							<!-- 查看发布日期 -->
							<div class="form-group background">
								...
								<div class="controls form-group">
									<span><fmt:formatDate value="${result.releaseDate}"
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<span><fmt:formatDate value="${result.startDate}"
											type="date" dateStyle="default" /></span>
								</div>
							</div>
							<!-- 查看结束日期 -->
							<div class="form-group background">
								...
								<div class="controls form-group">
									<span><fmt:formatDate value="${result.endDate}"
											type="date" dateStyle="default" /></span>
								</div>
							</div>
							<!-- 查看教学内容-->
							<div class="form-group background">
								<label class="col-sm-3 control-label">教学内容</label>
								<div class="controls form-group">
