			...
			<div class="content-wrapper">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">查看实训训练任务信息</h3>
					</div>
					<div id="breadcrumb">
						<a href="#" title="首页" class="tip-bottom"> <i
							class="icon-home"></i> Home
						</a> <a href="listClass.html">实训训练任务信息</a> <a href="#" class="current">查看实训训练任务信息</a>
					</div>
					<div class="panel-body">
						<form class="form-horizontal" method="post"
							action="/trainningTask/listOnly?id=${user.classId.id}" id="registerForm">
							<!-- 查看名字 -->
							...
							<!-- 查看训练内容-->
							<div class="form-group background">
								<label class="col-sm-3 control-label">训练内容</label>
								<div class="controls form-group">
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<span>${relationship.className.name}</span>
								</div>
							</div>
