			...
			<div class="content-wrapper">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">修改实训训练任务信息</h3>
					</div>
					<div id="breadcrumb">
						<a href="#" title="首页" class="tip-bottom"> <i
							class="icon-home"></i> Home
						</a> <a href="listClass.html">实训训练任务信息</a> <a href="#" class="current">修改实训训练任务信息</a>
					</div>
					<div class="panel-body">
						<form class="form-horizontal" method="post"
							action="/trainningTask/doEdit" id="registerForm">
							<input type="hidden" class="form-control" name="id"
								value="${trainningTask.id}" />
							<!-- 添加名字 -->
							<div class="form-group background">
								<label class="col-sm-3 control-label">名字</label>
								<div class="controls form-group">
									<input type="text" class="form-control" name="name"
										value="${trainningTask.name}" />
								</div>
							</div>
							<!-- 添加教务主管 -->
							<div class="form-group background">
									...
									<div class="dropdown btn-group" style="width: 50%">
										<button id="dLabel" class="btn btn-default dropdown-toggle"
											...
											<span id="trainningTeacherId"
												value="${trainningTask.trainningTeacher.id}">${trainningTask.trainningTeacher.name}</span>
											<span class="caret"></span>
										</button>
										<input id='trainningTeacher-input' name="trainningTeacher.id"
											value="${trainningTask.trainningTeacher.id}" hidden="true" />
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<input type="date" class="form-control" name="releaseDate"
										value="<fmt:formatDate  pattern="yyyy-MM-dd"  value="${trainningTask.releaseDate}"  type="date" dateStyle="default"/>" />
								</div>
							</div>
							<!-- 添加开始日期 -->
							<div class="form-group background">
								...
								<div class="controls form-group">
									<input type="date" class="form-control" name="startDate"
										value="<fmt:formatDate  pattern="yyyy-MM-dd"  value="${trainningTask.startDate}"  type="date" dateStyle="default"/>" />
								</div>
							</div>
							<!-- 添加结束日期 -->
							<div class="form-group background">
								...
								<div class="controls form-group">
									<input type="date" class="form-control" name="endDate"
										value="<fmt:formatDate  pattern="yyyy-MM-dd"  value="${trainningTask.endDate}"  type="date" dateStyle="default"/>" />
								</div>
							</div>
							<!-- 添加内容 -->
							<div class="form-group background">
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<div class="dropdown btn-group" style="width: 50%">
										<button id="dLabel" class="btn btn-default dropdown-toggle"
											type="button" data-toggle="dropdown" style="width: 100%">
											<span id="schoolId" value="${relationship.className.major.school.id}">${relationship.className.major.school.name}</span>
											<span class="caret"></span>
										</button>
										<input id='school-input' name="school.id"
											value="${relationship.className.major.school.id}" hidden="true" />
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<div class="dropdown btn-group" style="width: 50%">
										<button id="dLabel" class="btn btn-default dropdown-toggle"
											type="button" data-toggle="dropdown" style="width: 100%">
											<span id="majorId" value="${relationship.className.major.id}">${relationship.className.major.name}</span>
											<span class="caret"></span>
										</button>
										<input id='major-input' name="classId.major.id"
											value="${relationship.className.major.id}" hidden="true" />
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<div class="dropdown btn-group" style="width: 50%">
										<button id="dLabel" class="btn btn-default dropdown-toggle"
											type="button" data-toggle="dropdown" style="width: 100%">
											<span id="classId" value="${relationship.className.id}">${relationship.className.name}</span>
											<span class="caret"></span>
										</button>
										<input id='class-input' name="classId"
											value="${relationship.className.id}" hidden="true" />
