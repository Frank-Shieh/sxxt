			...
			<div class="content-wrapper">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">修改实训设备管理员信息</h3>
					</div>
					<div id="breadcrumb">
						<a href="#" title="首页" class="tip-bottom"> <i
							class="icon-home"></i> Home
						</a> <a href="listClass.html">实训设备管理员信息</a> <a href="#" class="current">修改实训设备管理员信息</a>
					</div>
					<div class="panel-body">
						<form class="form-horizontal" method="post"
							action="/equipmentManager/doEdit" id="registerForm">
							<input type="hidden" class="form-control" name="id"
								value="${equipmentManager.id}" />
							<!-- 添加工号 -->
							<div class="form-group background">
								<label class="col-sm-3 control-label">工号</label>
								<div class="controls form-group">
									<input type="text" class="form-control" name="code"
										value="${equipmentManager.code}" />
								</div>
							</div>
							<!-- 添加名字 -->
							<div class="form-group background">
								...
								<div class="controls form-group">
									<div class="dropdown btn-group" style="width: 50%">
										<button id="dLabel" class="btn btn-default dropdown-toggle"
											...
											<span id="companyId" value="${equipmentManager.company.id}">${equipmentManager.company.name}</span>
											<span class="caret"></span>
										</button>
										<input id='company-input' name="company.id"
											value="${equipmentManager.company.id}" hidden="true" />
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<input type="text" class="form-control" name="password"
										value="${equipmentManager.password}" />
								</div>
							</div>
