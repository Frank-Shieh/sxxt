			...
			<div class="content-wrapper">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">评价报告与总结信息</h3>
					</div>
					<div id="breadcrumb">
						<a href="#" title="首页" class="tip-bottom"> <i
							class="icon-home"></i> Home
						</a> <a href="listClass.html">报告与总结信息</a> <a href="#" class="current">评价报告与总结信息</a>
					</div>
					<div class="panel-body">
						<form class="form-horizontal" method="post"
							action="/reportAndSummary/doEdit" id="registerForm">
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<input type="date" class="form-control" name="writeDate"
										value="<fmt:formatDate value="${result.writeDate}"
											pattern="yyyy-MM-dd"  />" />
								</div>
							</div>
							<%-- 	<!-- 添加学校 -->
								...
								<div class="controls form-group">
									<div class="dropdown btn-group" style="width: 50%">
										<button id="dLabel" class="btn btn-default dropdown-toggle"
											...
											<span id="schoolId" value="${schoolList.get(0).id}">${result.student.school.name}</span>
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<div class="dropdown btn-group" style="width: 50%">
										<button id="dLabel" class="btn btn-default dropdown-toggle"
											type="button" data-toggle="dropdown" style="width: 100%">
											<span id="classId" value="${classList.get(0).id}">${result.student.classId.name}</span>
											<span class="caret"></span>
										</button>
										<input id='class-input' value="${classList.get(0).id}"
											hidden="true" />
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<div class="dropdown btn-group" style="width: 50%">
										<button id="dLabel" class="btn btn-default dropdown-toggle"
											type="button" data-toggle="dropdown" style="width: 100%">
											<span id="studentId" value="${result.student.id}">${result.student.name}</span>
											<span class="caret"></span>
										</button>
										<input id='student-input' name="student.id"
											value="${result.student.id}" hidden="true" />
