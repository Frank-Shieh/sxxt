				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<form class="form-horizontal" method="post"
							action="/reportAndSummary/doComment" id="registerForm">
							...
							<!-- 实训教师ID -->
							<input type="hidden" class="form-control"
								name="trainningTeacher.id" value="${result.trainningTeacher.id}" />
							<!-- 查看教师总结-->
							<div class="form-group background">
								<label class="col-sm-3 control-label">教师总结</label>
								<div class="controls form-group">
									<input type="text" class="form-control" name="teacherComment"
