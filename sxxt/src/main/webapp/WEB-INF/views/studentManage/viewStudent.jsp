			...
			<div class="content-wrapper">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">查看班级人员信息</h3>
					</div>
					<div id="breadcrumb">
					...
					<div class="panel-body">
						<form class="form-horizontal" method="post" action="/student/list?id=${result.classId.id}"
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<span><fmt:formatDate value="${result.birthDate}"
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<c:if test="${result.sex==1}">
										<span>男</span>
									</c:if>
									<c:if test="${result.sex==0}">
										<span>女</span>
									</c:if>
								</div>
							</div>
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<span>${result.familyAddress}</span>
								</div>
							</div>
							<!-- 查看父母名称 -->
							<div class="form-group background">
