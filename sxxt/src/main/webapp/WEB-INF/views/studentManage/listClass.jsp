					...
					<div class="col-xs-12">
						<div class="panel panel-info">
							<div class="panel-heading">
								<h3 class="panel-title">班级人员信息</h3>
							</div>
							<div class="panel-body">
								<table id="tp-result-table" class="table table-bordered table-striped">
									<thead>
										<tr>
											<th>学校名称</th>
											<th>专业名称</th>
									...
									<tbody>
										<c:forEach var="result" items="${result}">
											<tr>
											<td>${result.major.school.name}</td>
												<td>${result.major.name}</td>
												<td>${result.name}</td>
												<td><a class="btn btn-info"
													href="/student/list?id=${result.id}">查看</a></td>
												<td><a
													href="/class/edit?id=${result.id}"
													class="btn btn-primary">修改</a></td>
												<td><a class="btn btn-danger"
													onclick="delClass(${result.id})">删除</a></td>
											</tr>
										</c:forEach>
									</tbody>
