			...
			<div class="content-wrapper">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">修改学生实训成绩</h3>
					</div>
					<div id="breadcrumb">
						<a href="#" title="首页" class="tip-bottom"> <i
							class="icon-home"></i> Home
						</a> <a href="listClass.html">学生实训成绩</a> <a href="#" class="current">修改学生实训成绩</a>
					</div>
					<div class="panel-body">
						<form class="form-horizontal" method="post"
								...
								<div class="controls form-group">
									<div class="dropdown btn-group" style="width: 50%">
										<button id="dLabel" class="btn btn-default dropdown-toggle"
											...
											<span id="schoolId"
												value="${studentScore.classId.major.school.id}">${studentScore.classId.major.school.name}</span>
											<span class="caret"></span>
										</button>
										<input id='school-input'
											value="${studentScore.classId.major.school.id}" hidden="true" />
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<div class="dropdown btn-group" style="width: 50%">
										<button id="dLabel" class="btn btn-default dropdown-toggle"
											type="button" data-toggle="dropdown" style="width: 100%">
											<span id="majorId" value="${studentScore.classId.major.id}">${studentScore.classId.major.name}</span>
											<span class="caret"></span>
										</button>
										<input id='major-input'
											value="${studentScore.classId.major.id}" hidden="true" />
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<div class="dropdown btn-group" style="width: 50%">
										<button id="dLabel" class="btn btn-default dropdown-toggle"
											type="button" data-toggle="dropdown" style="width: 100%">
											<span id="classId" value="${studentScore.classId.id}">${studentScore.classId.name}</span>
											<span class="caret"></span>
										</button>
										<input id='class-input' name='classId.id'
											value="${studentScore.classId.id}" hidden="true" />
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<div class="dropdown btn-group" style="width: 50%">
										<button id="dLabel" class="btn btn-default dropdown-toggle"
											type="button" data-toggle="dropdown" style="width: 100%">
											<span id="studentId" value="${studentScore.student.id}">${studentScore.student.name}</span>
											<span class="caret"></span>
										</button>
										<input id='student-input' name="student.id"
											value="${studentScore.student.id}" hidden="true" />
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<input type="text" class="form-control" name="inducingAbility"
										value="${studentScore.inducingAbility}" />
								</div>
							</div>
							<div class="form-group background">
								<label class="col-sm-3 control-label">针对复杂工程问题的方案设计与实现</label>
								<div class="controls form-group">
									<input type="text" class="form-control" name="planExecute"
										value="${studentScore.planExecute}" />
								</div>
							</div>
							<div class="form-group background">
								<label class="col-sm-3 control-label">工程计划管控与执行情况</label>
								<div class="controls form-group">
									<input type="text" class="form-control" name="designImplement"
										value="${studentScore.designImplement}" />
								</div>
							</div>
							<div class="form-group background">
								<label class="col-sm-3 control-label">知识技能学习情况</label>
								<div class="controls form-group">
									<input type="text" class="form-control" name="skillLearning"
										value="${studentScore.skillLearning}" />
								</div>
							</div>
							<div class="form-group background">
								<label class="col-sm-3 control-label">工程协作与交流情况</label>
								<div class="controls form-group">
									<input type="text" class="form-control" name="teamAbility"
										value="${studentScore.teamAbility}" />
								</div>
							</div>
							<div class="form-group background">
								<label class="col-sm-3 control-label">对于职业岗位与职业素养的认识</label>
								<div class="controls form-group">
									<input type="text" class="form-control" name="professionalism"
										value="${studentScore.professionalism}" />
								</div>
							</div>
							<div class="form-group background">
								<label class="col-sm-3 control-label">工程文档写作水平</label>
								<div class="controls form-group">
									<input type="text" class="form-control" name="writingLevel"
										value="${studentScore.writingLevel}" />
								</div>
							</div>
							<div class="form-group background">
								<label class="col-sm-3 control-label">登分日期</label>
								<div class="controls form-group">
									<input type="date" class="form-control" name="scoreDate"
										value="<fmt:formatDate  pattern="yyyy-MM-dd" value="${studentScore.scoreDate}"  type="date" dateStyle="default"/>" />
								</div>
							</div>
