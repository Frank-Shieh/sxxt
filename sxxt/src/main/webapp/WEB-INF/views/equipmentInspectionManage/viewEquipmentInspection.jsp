			...
			<div class="content-wrapper">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">查看场地设备年检信息</h3>
					</div>
					<div id="breadcrumb">
						<a href="#" title="首页" class="tip-bottom"> <i
							class="icon-home"></i> Home
						</a> <a href="listClass.html">设备年检信息</a> <a href="#" class="current">查看设备年检信息</a>
					</div>
					<div class="panel-body">
						<form class="form-horizontal" method="post"
							action="/equipmentInspection/list/${result.equipmentInfo.id}" id="registerForm">
							<!-- 查看所属场地 -->
							<div class="form-group background">
								<label class="col-sm-3 control-label">所属场地</label>
								<div class="controls form-group">
									<span>${result.equipmentInfo.site.classroomCode}</span>
								</div>
							</div>
							<!-- 查看设备名称 -->
							<div class="form-group background">
								...
								<div class="controls form-group">
									<span>${result.equipmentInfo.name}</span>
								</div>
							</div>
							<!-- 查看设备数量 -->
							<div class="form-group background">
								...
								<div class="controls form-group">
									<span>${result.equipmentInfo.num}</span>
								</div>
							</div>
							...
							<!-- 查看设备年检内容 -->
							<div class="form-group background">
								<label class="col-sm-3 control-label">年检内容（以年为单位） </label>
								<div class="controls form-group">
