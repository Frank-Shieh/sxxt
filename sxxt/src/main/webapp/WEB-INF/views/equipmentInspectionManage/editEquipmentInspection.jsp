				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<form class="form-horizontal" method="post"
							action="/equipmentInspection/doEdit" id="registerForm">
								...
								<div class="controls form-group">
									<div class="dropdown btn-group" style="width: 50%">
										<button id="dLabel" class="btn btn-default dropdown-toggle"
											...
											<span id="siteId" value="${result.equipmentInfo.site.id}">${result.equipmentInfo.site.classroomCode}</span>
											<span class="caret"></span>
										</button>
										<input id='site-input' name="site.id"
											value="${result.equipmentInfo.site.id}" hidden="true" />
