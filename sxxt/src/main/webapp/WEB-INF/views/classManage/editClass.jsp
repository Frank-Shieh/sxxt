			...
			<div class="content-wrapper">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">修改单个班级信息</h3>
					</div>
					<div id="breadcrumb">
						<a href="#" title="首页" class="tip-bottom"> <i
							class="icon-home"></i> Home
						</a> <a href="listClass.html">班级信息</a> <a href="#" class="current">修改单个班级信息</a>
					</div>
					<div class="panel-body">
						<form class="form-horizontal" method="post"
							action="/class/doEdit" id="registerForm">
								...
								<div class="controls form-group">
									<div class="dropdown btn-group" style="width: 50%">
										<button id="dLabel" class="btn btn-default dropdown-toggle"
											...
											<span id="schoolId" value="${classId.major.school.id}">${classId.major.school.name}</span>
											<span class="caret"></span>
										</button>
										<input id='school-input' name="school.id"
											value="${classId.major.school.id}" hidden="true" />
									...
									<div hidden="true" class="new-school">
										<input type="text" class="form-control add-input"
											id="add-school-input" name="schoolName" />
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<div class="dropdown btn-group" style="width: 50%">
										<button id="dLabel" class="btn btn-default dropdown-toggle"
											type="button" data-toggle="dropdown" style="width: 100%">
											<span id="majorId" value="${classId.major.id}">${classId.major.name}</span>
											<span class="caret"></span>
										</button>
										<input id='major-input' name="major.id"
											value="${classId.major.id}" hidden="true" />
