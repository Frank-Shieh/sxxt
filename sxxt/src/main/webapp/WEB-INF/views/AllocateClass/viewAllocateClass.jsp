			...
			<div class="content-wrapper">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">查看班级教师分配信息</h3>
					</div>
					<div id="breadcrumb">
						<a href="#" title="首页" class="tip-bottom"> <i
							class="icon-home"></i> Home
						</a> <a href="listClass.html">班级教师分配信息</a> <a href="#" class="current">查看班级教师分配信息</a>
					</div>
					<div class="panel-body">
						<form class="form-horizontal" method="post"
							action="/allocateClass/list" id="registerForm">
							<!-- 查看学校名称 -->
							...
							<div class="form-group background">
								...
								<table>
									<c:forEach items="${teacherList}" var="s" varStatus="status">
										<tr><td><span>${s.trainningTeacher.name}</span></td></tr>
									</c:forEach>
									</table>
								</div>
