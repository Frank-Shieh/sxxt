...
<body class="hold-transition skin-blue sidebar-mini">
											...
											<c:forEach var="result" items="${result}">
												<tr>
													...
													<td><a class="btn btn-info"
														href="/equipmentInfo/viewRentAndAssign?id=${result.id}">查看</a></td>
													<td><a class="btn btn-primary"
														href="/equipmentInfo/rent?id=${result.id}">租借</a></td>
													<td><a class="btn btn-danger"
														href="/equipmentInfo/assign?id=${result.id}">分配</a></td>
													<td><a class="btn btn-info"
														href="/equipmentInfo/delState?id=${result.id}">撤销</a></td>
												</tr>
											</c:forEach>
	...
	<script type="text/javascript">
		function delState(id) {
			...
			if (result) {
				console.log(result);
				var url = '/equipmentInfo/delState?id=' + id;
				$.get(url, function(data) {
					console.log('deleted.');
					window.location.href = '/equipmentInfo/rentAndAssign';
				});
			}
		}
	</script>
