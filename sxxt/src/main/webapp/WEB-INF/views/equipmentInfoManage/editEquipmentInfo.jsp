			...
			<div class="content-wrapper">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">修改场地设备信息</h3>
					</div>
					<div id="breadcrumb">
								...
								<div class="controls form-group">
									<div class="dropdown btn-group" style="width: 50%">
										<button id="dLabel" class="btn btn-default dropdown-toggle"
											...
											<span id="siteId" value="${result.site.id}">${result.site.classroomCode}</span>
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<input type="date" class="form-control" name="buyDate"
										value="<fmt:formatDate  pattern="yyyy-MM-dd" value="${result.buyDate}"  type="date" dateStyle="default"/>" />
								</div>
							</div>
							<!-- 添加出产日期 -->
							<div class="form-group background">
								...
								<div class="controls form-group">
									<input type="date" class="form-control" name="produceDate"
										value="<fmt:formatDate  pattern="yyyy-MM-dd" value="${result.produceDate}"  type="date" dateStyle="default"/>" />
								</div>
							</div>
							<!-- 添加下次年检日期 -->
							<div class="form-group background">
								...
								<div class="controls form-group">
									<input type="date" class="form-control" name="inspectionDate"
										value="<fmt:formatDate  pattern="yyyy-MM-dd" value="${result.inspectionDate}"  type="date" dateStyle="default"/>" />
								</div>
							</div>
							<!-- 添加设备年检期限 -->
							<div class="form-group background">
									...
									<div class="dropdown btn-group" style="width: 50%">
										<button id="dLabel" class="btn btn-default dropdown-toggle"
											...
											<span id="equipmentManagerId"
												value="${result.equipmentManager.id}">${result.equipmentManager.name}</span>
											<span class="caret"></span>
										</button>
