			...
			<div class="content-wrapper">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">租借设备信息</h3>
					</div>
					<div id="breadcrumb">
						<a href="#" title="首页" class="tip-bottom"> <i
							class="icon-home"></i> Home
						</a> <a href="listClass.html">设备信息</a> <a href="#" class="current">租借场地设备信息</a>
					</div>
					<div class="panel-body">
						<form class="form-horizontal" method="post"
							action="/equipmentInfo/doRent" id="registerForm">
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<input type="date" class="form-control" name="rentDate"
										value="<fmt:formatDate  pattern="yyyy-MM-dd" value="${result.rentDate}"  type="date" dateStyle="default"/>" />
								</div>
							</div>
							<!-- 修改归还日期 -->
							<div class="form-group background">
								...
								<div class="controls form-group">
									<input type="date" class="form-control" name="returnDate"
										value="<fmt:formatDate  pattern="yyyy-MM-dd" value="${result.returnDate}"  type="date" dateStyle="default"/>" />
								</div>
							</div>
							<!-- 修改租借金额 -->
							<div class="form-group background">
							...
							<div class="form-group background">
								...
								<div class="controls form-group">
									<input type="radio" name="state" value="4"
										<c:if test="${result.state eq 4}">checked</c:if>> <label
										class="radio-label">租用</label> <input type="radio"
										name="state" value="3"
										<c:if test="${result.state eq 3}">checked</c:if>> <label
										class="radio-label">借用</label>
								</div>
							</div>
